...
namespace MailFlow.API.Migrations
{
    ...
    [Migration("20250513131112_OneOnOneRelationEmailMessageAndEmailMessageContent")]
    partial class OneOnOneRelationEmailMessageAndEmailMessageContent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MailFlow.API.Controllers.EmailMessageContent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MailFlow.API.Controllers.EmailMessageContent", b =>
                {
                    b.HasOne("MailFlow.API.Controllers.EmailMessage", "EmailMessage")
                        .WithOne("Content")
                        .HasForeignKey("MailFlow.API.Controllers.EmailMessageContent", "EmailMessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
